...
CREATE TABLE satellite (
    ...
    periodo_orbitale INTERVAL DAY(9) TO SECOND(0),
    data_di_lancio TIMESTAMP,
...
CREATE TABLE rilevazione (
    ...
    CONSTRAINT fk_coordinate_orbitali_rilevazione FOREIGN KEY (
        ...
        coordinate_orbitali_eccentricita
    ) REFERENCES coordinate_orbitali(altitudine, inclinazione, eccentricita),
